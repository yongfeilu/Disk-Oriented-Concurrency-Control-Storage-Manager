...
void HashTableDirectoryPage::IncrGlobalDepth() {
  ...
  // add global depth -> add bucket pointers ->
  // redistribute new pointers to buckets ->
  // set local depths for each bucket
  int org_num = Size();
...
auto HashTableDirectoryPage::CanShrink() -> bool {
  // check if every bucket's local depth is less than global depth
